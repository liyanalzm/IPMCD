                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                        ...
                                        <ul class="nav navbar-nav navbar-right">
                                            ...
                                            <li><a href="index.html#intake">Intake</a></li>
                                            <li><a href="index.html#blog">Preparation</a></li>
                                            <li><a href="index.html#portfolio">Combination</a></li>
                                            <li><a href="index.html#choose"> About us</a></li>
        ...
        <section class="secondPageIsi">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 ">
                           <h2>Breakfast</h2>
                           <p>Indulge more on the intake and preparation.</p>
                           <br/>
                           <table></table>
